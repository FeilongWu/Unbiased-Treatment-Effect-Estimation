...
if __name__ == "__main__":
    ...
    hyperparameters = {'synthetic':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],'std_ws':[-100,-50,0,50],\
                                'h_dims':[10,14,18], 'y_stds':[0.003],'hiddens':[0.8,0.9,1.0],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[12,16,20], \
                                    't_grids':[8,10,12], 'dzs':[1.0,1.05,1.1]},
                       'news':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],'std_ws':[-100,-50,0,50],\
                                'h_dims':[430,530,630], 'y_stds':[0.003],'hiddens':[0.8,0.9,1.0],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[450,550,650], \
                                    't_grids':[8,10,12], 'dzs':[1.0,1.05,1.1]},
                       'mimiciii':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],'std_ws':[-100,-50,0,50],\
                                'h_dims':[28,38,48], 'y_stds':[0.003],'hiddens':[0.8,0.9,1.0],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[32,42,52], \
                                    't_grids':[8,10,12], 'dzs':[1.0,1.05,1.1]},
                       'tcga':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],'std_ws':[-100,-50,0,50],\
                                'h_dims':[460,560,660], 'y_stds':[0.003],'hiddens':[0.8,0.9,1.0],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[480,580,680], \
                                    't_grids':[8,10,12], 'dzs':[1.0,1.05,1.1]}}[dataset]
                            ...
                            for hidden in hyperparameters['hiddens']:
                                ...
                                for std_w in hyperparameters['std_ws']:
                                    ...
                                    for r in range(replications):
                                        ...
                                        x,t,y,ids,response_data = load_data(dataset, r, gamma=gamma)
