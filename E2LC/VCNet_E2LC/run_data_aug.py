...
if __name__ == "__main__":
    ...
    test_ratio = 0.2
    batch_size = 150              
    hyperparameters = {'synthetic':{'num_units':[10,14,18], 'lrs':[(0.001,0.001),(0.0001,0.0001),(0.00001,0.00001)],\
                                'alphas':[0.0, 0.5,0.8], 'num_grids':[9,10,11],\
                                'n_layers':[2], 'hiddens':[0.9,1.0,1.1], 't_grids':[8,10,12],\
                                'dzs':[1.0,1.05,1.1], 'std_ws':[-100,-50,0,50], 'y_stds':[0.005]},
                       'news':{'num_units':[430,530,630], 'lrs':[(0.001,0.001),(0.0001,0.0001),(0.00001,0.00001)],\
                                'alphas':[0.0, 0.5,0.8], 'num_grids':[9,10,11],\
                                'n_layers':[2], 'hiddens':[0.9,1.0,1.1], 't_grids':[8,10,12],\
                                'dzs':[1.0,1.05,1.1], 'std_ws':[-100,-50,0,50], 'y_stds':[0.005]},
                       'mimiciii':{'num_units':[30,40,50], 'lrs':[(0.001,0.001),(0.0001,0.0001),(0.00001,0.00001)],\
                                'alphas':[0.0, 0.5,0.8], 'num_grids':[9,10,11],\
                                'n_layers':[2], 'hiddens':[0.9,1.0,1.1], 't_grids':[8,10,12],\
                                'dzs':[1.0,1.05,1.1], 'std_ws':[-100,-50,0,50], 'y_stds':[0.005]},
                       'tcga':{'num_units':[460,560,660], 'lrs':[(0.001,0.001),(0.0001,0.0001),(0.00001,0.00001)],\
                                'alphas':[0.0, 0.5,0.8], 'num_grids':[9,10,11],\
                                'n_layers':[2], 'hiddens':[0.9,1.0,1.1], 't_grids':[8,10,12],\
                                'dzs':[1.0,1.05,1.1], 'std_ws':[-100,-50,0,50], 'y_stds':[0.005]}}[dataset]
    replications = 5
