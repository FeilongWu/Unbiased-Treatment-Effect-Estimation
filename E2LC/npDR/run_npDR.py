...
if __name__ == "__main__":
    ...
    test_ratio = 0.2
    batch_size = 150
    hyperparameters = {'synthetic':{'num_units':[1.1,1.2,1.3], 'lrs':[0.001,0.0001,0.00001],\
                                'layers':[1,2,3]},
                       'news':{'num_units':[1.1,1.2,1.3], 'lrs':[0.001,0.0001,0.00001],\
                                'layers':[1,2,3]},
                       'mimiciii':{'num_units':[1.1,1.2,1.3], 'lrs':[0.001,0.0001,0.00001],\
                                'layers':[1,2,3]},
                       'tcga':{'num_units':[1.1,1.2,1.3], 'lrs':[0.001,0.0001,0.00001],\
                                'layers':[1,2,3]}}[dataset]
    replications = 5
