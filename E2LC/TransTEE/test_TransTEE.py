...
if __name__ == "__main__":
    ...
    hyperparameters = {'synthetic':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],\
                                'h_dims':[10,14,18], 'alphas':[0.5],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[12,16,20] },
                       'news':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],\
                                'h_dims':[430,530,630], 'alphas':[0.5],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[450,550,650] },
                       'mimiciii':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],\
                                'h_dims':[28,38,48], 'alphas':[0.5],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[32,42,52] },
                       'tcga':{'num_dosage_samples':[5], 'h_inv_eqv_dims':[64],\
                                'h_dims':[460,560,660], 'alphas':[0.5],\
                                'lrs':[0.001,0.0001,0.00001],'cov_dims':[480,580,680] }}[dataset]
