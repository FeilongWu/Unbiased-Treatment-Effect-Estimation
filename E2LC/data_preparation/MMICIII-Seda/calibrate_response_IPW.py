...
def fit_curve(data, t, density_model,upper=10,lower=0,\
    ...
    if plot_single:
        ...
        if use_IPW:
            save_pth = 'mimiciii_seda_response_curve_calibrate_IPW.pickle'
            ...
            save_pth = 'mimiciii_seda_response_curve_calibrate.pickle'
            if os.path.isfile(save_pth):
                with open(save_pth, 'rb') as file:
                    result = pickle.load(file)
                    start = len(result) + 1
...
if __name__ == '__main__':
    t_min, t_max_min = 0.04545455, 0.97913565491803
    y_mu = 0.0
    y_std = 1.0

    path = './mimiciii_seda.csv'
    ...
    regimes = [(0.0,0.2),(0.2,0.35),(0.35,0.7),(0.7,1.0)]
