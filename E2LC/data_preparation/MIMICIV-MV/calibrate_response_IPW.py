...
def fit_curve(data, t, density_model,upper=10,lower=0,\
    ...
    if plot_single:
        ...
        if use_IPW:
            save_pth = 'mimiciv_mv_response_curve_calibrate_IPW.pickle'
            ...
            save_pth = 'mimiciv_mv_response_curve_calibrate.pickle'
            if os.path.isfile(save_pth):
                with open(save_pth, 'rb') as file:
                    result = pickle.load(file)
                    start = len(result) + 1
...
if __name__ == '__main__':
    path_lable = './mimiciv_mv.csv'
    t_min, t_max_min = 40.5, 222.555-40.5
    y_mu = 42.648
    y_std = 8.5920925341
    ...
    regimes = [(0.0,0.2),(0.2,0.4),(0.4,0.6),(0.6,0.8),(0.8,1.0)]
