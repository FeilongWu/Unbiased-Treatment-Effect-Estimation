...
if __name__ == "__main__":
    ...
    hyperparameters = {'synthetic':{'h_dims':[10,14,18], 'lrs':[0.001,0.0001,0.00001], \
                                'num_dosage_samples':[4,5,6],\
                                'epochs':[ 500, 1000, 1200, 2000, 2200 ]},
                       'news':{'h_dims':[430,530,630], 'lrs':[0.001,0.0001,0.00001], \
                                'num_dosage_samples':[4,5,6],\
                                'epochs':[ 500, 1000, 1200, 2000, 2200 ]},
                       'mimiciii':{'h_dims':[27,37,47 ], 'lrs':[0.001,0.0001,0.00001], \
                                'num_dosage_samples':[4,5,6],\
                                'epochs':[ 200,500, 1000, 1200, 2000  ]},
                       'tcga':{'h_dims':[460,560,660], 'lrs':[0.001,0.0001,0.00001], \
                                'num_dosage_samples':[4,5,6],\
                                'epochs':[ 500, 1000, 1200, 2000, 2200 ]}}[dataset_name]
            ...
            for num_dosage_sample in num_dosage_samples:
                ...
                for epoch in epochs:
                    ...
                    for rep in range(replications):
                        ...
                        data_class = TCGA_Data(dataset_params, dataset_name, rep, gamma=gamma)
